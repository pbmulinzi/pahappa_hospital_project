...
public class MedicalRecordDao {
    ...
    public List<MedicalRecord> getAllActiveMedicalRecords() {
        try (Session session = sessionFactory.openSession()) {
            session.enableFilter("deletedRecordFilter")
                    .setParameter("isDeleted", false);
            return session.createQuery("FROM com.pahappa.hospital.models.MedicalRecord", MedicalRecord.class).list();
        }
    }
    ...
    public List<MedicalRecord> getRecordsByPatient(Patient patient) {
        try (Session session = sessionFactory.openSession()) {
            ...
            Query<MedicalRecord> query = session.createQuery(
                    "FROM com.pahappa.hospital.models.MedicalRecord WHERE patient = :patient",
                    MedicalRecord.class
            );
    ...
    public List<MedicalRecord> getRecordsByDoctor(Doctor doctor) {
        try (Session session = sessionFactory.openSession()) {
            session.enableFilter("deletedRecordFilter")
                    .setParameter("isDeleted", false);
            Query<MedicalRecord> query = session.createQuery(
                    "FROM com.pahappa.hospital.models.MedicalRecord WHERE doctor = :doctor",
                    MedicalRecord.class
            );
    ...
    public List<MedicalRecord> getRecordsByDateRange(LocalDate start, LocalDate end) {
        try (Session session = sessionFactory.openSession()) {
            session.enableFilter("deletedRecordFilter")
                    .setParameter("isDeleted", false);
            Query<MedicalRecord> query = session.createQuery(
                    "FROM com.pahappa.hospital.models.MedicalRecord WHERE recordDate BETWEEN :start AND :end",
                    MedicalRecord.class
            );
    ...
    public List<MedicalRecord> searchRecordsByDiagnosis(String keyword) {
        try (Session session = sessionFactory.openSession()) {
            session.enableFilter("deletedRecordFilter")
                    .setParameter("isDeleted", false);
            Query<MedicalRecord> query = session.createQuery(
                    "FROM com.pahappa.hospital.models.MedicalRecord WHERE LOWER(diagnosis) LIKE :keyword",
                    MedicalRecord.class
            );
    ...
    public List<MedicalRecord> getPatientMedicalHistory(int patientId) {
        try (Session session = sessionFactory.openSession()) {
            session.enableFilter("deletedRecordFilter")
                    .setParameter("isDeleted", false);
            Query<MedicalRecord> query = session.createQuery(
                    "FROM com.pahappa.hospital.models.MedicalRecord WHERE patient.patientId = :patientId ORDER BY recordDate DESC",
                    MedicalRecord.class
            );
